...
A critical element of the SF COE was to have a practical set of resources for taxonomy. Therefore, the OS-SFT agreed with the SF COE to be that founding technical resource to help drive innovation across all aspects of the SF Roadmap, including data resources and fintech solutiuon componenrty.
