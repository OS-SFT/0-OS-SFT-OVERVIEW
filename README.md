...
The project has its origins in July, 2021 when Johnny Mattimore of [First Derivative](https://firstderivative.com/) and John Byrne of [Corlytics](https://www.corlytics.com/) weren researching how best to solve the huge issue of new data requirements for sustainable finance (**SF**), including the domains of Climate Change and ESG. The problem kept returning to "data" in its holistic sense - what data, how to find it, how to make it ready for use by financial services firms. 
